...
class PresentationMatrixSmokeTest(unittest.TestCase):
    def test_direct_presentation_ladder(self) -> None:
    ...
    def test_matrix_presentation_ladder(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
    ...
    def test_preview_cli_matrix(self) -> None:
        cases = [
            argparse.Namespace(
                kind="stale_mirror",
                root=None,
