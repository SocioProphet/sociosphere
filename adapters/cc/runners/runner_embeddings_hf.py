...
class EmbeddingsHFRunner:
    """HuggingFace-backed text embedding runner.

    Args:
        hf_id:   HuggingFace model identifier (e.g. 'sentence-transformers/all-MiniLM-L6-v2').
        pooling: 'mean' (default) or 'cls'.
    """

    def __init__(self, hf_id: str, pooling: str = "mean") -> None:
        self.hf_id = hf_id
    ...
    def infer(self, batch: List[Dict[str, Any]]) -> List[List[float]]:
        """Return a list of embedding vectors (one per input item)."""
